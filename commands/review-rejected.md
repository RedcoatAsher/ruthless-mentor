...
4. For each entry, ask the user to choose:
   - **Reincorporate** — move to `RM_accepted.md` (remove from `RM_rejected.md`)
   - **Graveyard** — move to `RM_graveyard.md` (remove from `RM_rejected.md`)
   - **Keep rejected** — leave in `RM_rejected.md` for now
